...
It is partly for this purpose that the Contacts-Swagger quickstart uses the [Swagger](http://swagger.io) tool to generate API documentation. 

Not only does Swagger use [annotations](https://github.com/swagger-api/swagger-core/wiki/Annotations-1.5.X) to automatically generate attractive documentation for API endpoints, but this documentation is interactive.
...
An example of swagger documentation can be found [here](http://petstore.swagger.io/).
